...
class UserAuthClass(TestSetUp):
    ...
    def test_logout(self):
        """Test logout success"""
        response = self.app.delete('/api/v1/auth/logout',headers={"x-access-token": self.token})
    ...
    def test_reset_password(self):
        ...
        response = self.app.put('/api/v1/auth/reset-password',
                data=json.dumps(dict(password="new_pass")), content_type="application/json", 
